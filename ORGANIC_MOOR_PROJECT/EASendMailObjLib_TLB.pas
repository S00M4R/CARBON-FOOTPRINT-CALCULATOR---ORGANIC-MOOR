...
// PASTLWTR : 1.2
// File generated on 2/10/2023 4:36:11 PM from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll (1)
...
// Errors:
//   Error creating palette bitmap of (TMail) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TFastSender) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TCertificate) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TCertificateCollection) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TSimpleJsonParser) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TSimpleJsonArray) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TOAuthResponseParser) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TBrowserUi) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (THttpListener) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
//   Error creating palette bitmap of (TDkimConfig) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
...
const
  ...
  IID_IDkimConfig: TGUID = '{DA08318D-E853-4E45-AA3F-2B95CC51C16C}';
  ...
  IID_IBrowserUi: TGUID = '{217785E8-1188-4FDD-BBB8-1EB104D32151}';
  IID_IHttpListener: TGUID = '{011E1175-8AC1-40D5-BC61-903999FAAC8D}';
  ...
  IID_IOAuthResponseParser: TGUID = '{2B8C75E2-9631-4834-9D3B-32C51C7FB962}';
  CLASS_OAuthResponseParser: TGUID = '{60534020-0887-486D-B6B7-0F177D43C00C}';
  CLASS_BrowserUi: TGUID = '{539C9DBC-57D4-4ACB-8A91-329A2CC6270E}';
  DIID__IHttpListenerEvents: TGUID = '{A386C7CB-8547-451E-A7DC-CD74BA675247}';
  CLASS_HttpListener: TGUID = '{7CFF2534-946A-495E-A356-7D01F71F3449}';
  CLASS_DkimConfig: TGUID = '{65653AA2-8E17-4F5C-A8C3-1991E8856359}';
type
...
// *********************************************************************//
  ...
  IDkimConfig = interface;
  IDkimConfigDisp = dispinterface;
  ...
  IBrowserUi = interface;
  IBrowserUiDisp = dispinterface;
  IHttpListener = interface;
  IHttpListenerDisp = dispinterface;
  _IMailEvents = dispinterface;
  _IFastSenderEvents = dispinterface;
  IOAuthResponseParser = interface;
  IOAuthResponseParserDisp = dispinterface;
  _IHttpListenerEvents = dispinterface;
...
// *********************************************************************//
  ...
  OAuthResponseParser = IOAuthResponseParser;
  BrowserUi = IBrowserUi;
  HttpListener = IHttpListener;
  DkimConfig = IDkimConfig;
...
// *********************************************************************//
  IMail = interface(IDispatch)
    ...
    function Get_IsTaskCompleted: WordBool; safecall;
    ...
    function Get_AttachmentEncoding: Integer; safecall;
    procedure Set_AttachmentEncoding(pVal: Integer); safecall;
    function Get_SignatureEncryptionAlgorithm: Integer; safecall;
    procedure Set_SignatureEncryptionAlgorithm(pVal: Integer); safecall;
    function Get_OaepHashAlgorithm: Integer; safecall;
    procedure Set_OaepHashAlgorithm(pVal: Integer); safecall;
    procedure Set_ConnectType(pVal: Integer); safecall;
    function Get_ConnectType: Integer; safecall;
    procedure Set_EWSImpersonatedUser(const pVal: WideString); safecall;
    function Get_EWSImpersonatedUser: WideString; safecall;
    procedure Set_DkimSignerConfig(const pVal: IDkimConfig); safecall;
    function Get_DkimSignerConfig: IDkimConfig; safecall;
    function SaveAsDraft: Integer; safecall;
    ...
    property IsTaskCompleted: WordBool read Get_IsTaskCompleted;
    ...
    property AttachmentEncoding: Integer read Get_AttachmentEncoding write Set_AttachmentEncoding;
    property SignatureEncryptionAlgorithm: Integer read Get_SignatureEncryptionAlgorithm write Set_SignatureEncryptionAlgorithm;
    property OaepHashAlgorithm: Integer read Get_OaepHashAlgorithm write Set_OaepHashAlgorithm;
    property ConnectType: Integer read Get_ConnectType write Set_ConnectType;
    property EWSImpersonatedUser: WideString read Get_EWSImpersonatedUser write Set_EWSImpersonatedUser;
    property DkimSignerConfig: IDkimConfig read Get_DkimSignerConfig write Set_DkimSignerConfig;
  end;
...
// *********************************************************************//
  IMailDisp = dispinterface
    ...
    property IsTaskCompleted: WordBool readonly dispid 61;
    ...
    property AttachmentEncoding: Integer dispid 122;
    property SignatureEncryptionAlgorithm: Integer dispid 123;
    property OaepHashAlgorithm: Integer dispid 124;
    property ConnectType: Integer dispid 125;
    property EWSImpersonatedUser: WideString dispid 126;
    property DkimSignerConfig: IDkimConfig dispid 127;
    function SaveAsDraft: Integer; dispid 128;
  end;
...
// *********************************************************************//
  ICertificate = interface(IDispatch)
    ...
    function SignMessageEx(Content: OleVariant; SignatureHashAlgorithm: Integer; 
                           SignatureHashEncryption: Integer): OleVariant; safecall;
    function Get_Base64Thumbprint: WideString; safecall;
    ...
    property Base64Thumbprint: WideString read Get_Base64Thumbprint;
...
// *********************************************************************//
  ICertificateDisp = dispinterface
    ...
    function SignMessageEx(Content: OleVariant; SignatureHashAlgorithm: Integer; 
                           SignatureHashEncryption: Integer): OleVariant; dispid 20;
    property Base64Thumbprint: WideString readonly dispid 21;
    property Thumbprint: WideString readonly dispid 22;
  end;
...
// *********************************************************************//
  ICertificateCollection = interface(IDispatch)
    ...
    function GetLastError: WideString; safecall;
    function EncryptMessageEx(EncryptionAlgorithm: Integer; OaepHashAlgorithm: Integer; 
                              Content: OleVariant): OleVariant; safecall;
...
// *********************************************************************//
  ICertificateCollectionDisp = dispinterface
    ...
    function EncryptMessageEx(EncryptionAlgorithm: Integer; OaepHashAlgorithm: Integer; 
                              Content: OleVariant): OleVariant; dispid 10;
  end;

// *********************************************************************//
// Interface: IDkimConfig
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {DA08318D-E853-4E45-AA3F-2B95CC51C16C}
// *********************************************************************//
  IDkimConfig = interface(IDispatch)
    ['{DA08318D-E853-4E45-AA3F-2B95CC51C16C}']
    ...
    procedure Set_Selector(const pVal: WideString); safecall;
    function Get_PrivateKey: WideString; safecall;
    procedure Set_PrivateKey(const pVal: WideString); safecall;
    function Get_HeadersToSign: WideString; safecall;
    procedure Set_HeadersToSign(const pVal: WideString); safecall;
    function Get_IsSignHeaderOnly: WordBool; safecall;
    procedure Set_IsSignHeaderOnly(pVal: WordBool); safecall;
    function Get_RsaHashAlgorithm: Integer; safecall;
    procedure Set_RsaHashAlgorithm(pVal: Integer); safecall;
    function Get_CanonAlgorithm: Integer; safecall;
    procedure Set_CanonAlgorithm(pVal: Integer); safecall;
    function Get_PublicKey: WideString; safecall;
    function LoadFromJson(const json: WideString): WordBool; safecall;
    function LoadFromFile(const jsonFile: WideString): WordBool; safecall;
    function ToJson: WideString; safecall;
    function SaveToFile(const jsonFile: WideString; overwrite: WordBool): WordBool; safecall;
    property Domain: WideString read Get_Domain write Set_Domain;
    property Selector: WideString read Get_Selector write Set_Selector;
    property PrivateKey: WideString read Get_PrivateKey write Set_PrivateKey;
    property HeadersToSign: WideString read Get_HeadersToSign write Set_HeadersToSign;
    property IsSignHeaderOnly: WordBool read Get_IsSignHeaderOnly write Set_IsSignHeaderOnly;
    property RsaHashAlgorithm: Integer read Get_RsaHashAlgorithm write Set_RsaHashAlgorithm;
    property CanonAlgorithm: Integer read Get_CanonAlgorithm write Set_CanonAlgorithm;
    property PublicKey: WideString read Get_PublicKey;
  end;

// *********************************************************************//
// DispIntf:  IDkimConfigDisp
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {DA08318D-E853-4E45-AA3F-2B95CC51C16C}
// *********************************************************************//
  IDkimConfigDisp = dispinterface
    ['{DA08318D-E853-4E45-AA3F-2B95CC51C16C}']
    property Domain: WideString dispid 1;
    property Selector: WideString dispid 2;
    property PrivateKey: WideString dispid 3;
    property HeadersToSign: WideString dispid 4;
    property IsSignHeaderOnly: WordBool dispid 5;
    property RsaHashAlgorithm: Integer dispid 6;
    property CanonAlgorithm: Integer dispid 7;
    property PublicKey: WideString readonly dispid 8;
    function LoadFromJson(const json: WideString): WordBool; dispid 9;
    function LoadFromFile(const jsonFile: WideString): WordBool; dispid 10;
    function ToJson: WideString; dispid 11;
    function SaveToFile(const jsonFile: WideString; overwrite: WordBool): WordBool; dispid 12;
  end;
...
// *********************************************************************//
  ISimpleJsonParser = interface(IDispatch)
    ...
    function GetStringValue(const Source: WideString; const Key: WideString): WideString; safecall;
    function GetIntValue(const Source: WideString; const Key: WideString): Integer; safecall;
    function GetBoolValue(const Source: WideString; const Key: WideString): WordBool; safecall;
    function JwtBase64UrlEncode(const Input: WideString): WideString; safecall;
    function JwtBase64UrlDecode(const Input: WideString): WideString; safecall;
    function SignRs256(const PfxCertificate: ICertificate; const Playload: WideString): WideString; safecall;
    function SignRs256WithPrivateKey(const RsaPrivateKey: WideString; const Playload: WideString): WideString; safecall;
    function GetCurrentIAT: Integer; safecall;
  end;
...
// *********************************************************************//
  ISimpleJsonParserDisp = dispinterface
    ...
    function GetStringValue(const Source: WideString; const Key: WideString): WideString; dispid 4;
    function GetIntValue(const Source: WideString; const Key: WideString): Integer; dispid 5;
    function GetBoolValue(const Source: WideString; const Key: WideString): WordBool; dispid 6;
    function JwtBase64UrlEncode(const Input: WideString): WideString; dispid 7;
    function JwtBase64UrlDecode(const Input: WideString): WideString; dispid 8;
    function SignRs256(const PfxCertificate: ICertificate; const Playload: WideString): WideString; dispid 9;
    function SignRs256WithPrivateKey(const RsaPrivateKey: WideString; const Playload: WideString): WideString; dispid 10;
    function GetCurrentIAT: Integer; dispid 11;
  end;

// *********************************************************************//
// Interface: IBrowserUi
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {217785E8-1188-4FDD-BBB8-1EB104D32151}
// *********************************************************************//
  IBrowserUi = interface(IDispatch)
    ['{217785E8-1188-4FDD-BBB8-1EB104D32151}']
    function OpenUrl(const URL: WideString): WordBool; safecall;
    function OpenIEObject(const URL: WideString; Left: Integer; Top: Integer; Height: Integer; 
                          Width: Integer): WordBool; safecall;
    function GetLastError: WideString; safecall;
    function OpenIE(const URL: WideString; IsPrivate: WordBool): WordBool; safecall;
    function GetIEVersion: WideString; safecall;
    procedure ClosePrivateIE; safecall;
    function IsPrivateIEClosed: WordBool; safecall;
    procedure CloseBrowserByTitle(const Title: WideString); safecall;
  end;

// *********************************************************************//
// DispIntf:  IBrowserUiDisp
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {217785E8-1188-4FDD-BBB8-1EB104D32151}
// *********************************************************************//
  IBrowserUiDisp = dispinterface
    ['{217785E8-1188-4FDD-BBB8-1EB104D32151}']
    function OpenUrl(const URL: WideString): WordBool; dispid 1;
    function OpenIEObject(const URL: WideString; Left: Integer; Top: Integer; Height: Integer; 
                          Width: Integer): WordBool; dispid 2;
    function GetLastError: WideString; dispid 3;
    function OpenIE(const URL: WideString; IsPrivate: WordBool): WordBool; dispid 4;
    function GetIEVersion: WideString; dispid 5;
    procedure ClosePrivateIE; dispid 6;
    function IsPrivateIEClosed: WordBool; dispid 7;
    procedure CloseBrowserByTitle(const Title: WideString); dispid 8;
  end;

// *********************************************************************//
// Interface: IHttpListener
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {011E1175-8AC1-40D5-BC61-903999FAAC8D}
// *********************************************************************//
  IHttpListener = interface(IDispatch)
    ['{011E1175-8AC1-40D5-BC61-903999FAAC8D}']
    function Create(const IPv4Address: WideString; Port: Integer): WordBool; safecall;
    function GetRequestUrl(Timeout: Integer): WordBool; safecall;
    function SendResponse(const ResponseCode: WideString; const ContentType: WideString; 
                          const Content: WideString): WordBool; safecall;
    procedure Close; safecall;
    function Get_RequestUrl: WideString; safecall;
    function Get_ListenPort: Integer; safecall;
    function GetLastError: WideString; safecall;
    procedure ClearUrl; safecall;
    function BeginGetRequestUrl: WordBool; safecall;
    property RequestUrl: WideString read Get_RequestUrl;
    property ListenPort: Integer read Get_ListenPort;
  end;

// *********************************************************************//
// DispIntf:  IHttpListenerDisp
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {011E1175-8AC1-40D5-BC61-903999FAAC8D}
// *********************************************************************//
  IHttpListenerDisp = dispinterface
    ['{011E1175-8AC1-40D5-BC61-903999FAAC8D}']
    function Create(const IPv4Address: WideString; Port: Integer): WordBool; dispid 1;
    function GetRequestUrl(Timeout: Integer): WordBool; dispid 2;
    function SendResponse(const ResponseCode: WideString; const ContentType: WideString; 
                          const Content: WideString): WordBool; dispid 3;
    procedure Close; dispid 4;
    property RequestUrl: WideString readonly dispid 5;
    property ListenPort: Integer readonly dispid 6;
    function GetLastError: WideString; dispid 7;
    procedure ClearUrl; dispid 8;
    function BeginGetRequestUrl: WordBool; dispid 9;
  end;
...
// *********************************************************************//
  _IMailEvents = dispinterface
    ...
    procedure OnSendCommand(const Command: WideString); dispid 6;
    procedure OnServerRespond(const Response: WideString); dispid 7;
    procedure OnWriteLog(const LogContent: WideString); dispid 8;
  end;
...
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {2B8C75E2-9631-4834-9D3B-32C51C7FB962}
// *********************************************************************//
  IOAuthResponseParser = interface(IDispatch)
    ['{2B8C75E2-9631-4834-9D3B-32C51C7FB962}']
    procedure Load(const Input: WideString); safecall;
    ...
    function Get_IdToken: WideString; safecall;
    function Get_TokenExpiresInSeconds: Integer; safecall;
    procedure Set_TokenExpiresInSeconds(pVal: Integer); safecall;
    function Get_EmailInIdToken: WideString; safecall;
    procedure Set_EmailInIdToken(const pVal: WideString); safecall;
    function Get_AccessTokenTimestamp: TDateTime; safecall;
    function SaveToFile(const tokenFile: WideString): WordBool; safecall;
    function LoadFromFile(const tokenFile: WideString): WordBool; safecall;
    ...
    property IdToken: WideString read Get_IdToken;
    property TokenExpiresInSeconds: Integer read Get_TokenExpiresInSeconds write Set_TokenExpiresInSeconds;
    property EmailInIdToken: WideString read Get_EmailInIdToken write Set_EmailInIdToken;
    property AccessTokenTimestamp: TDateTime read Get_AccessTokenTimestamp;
  end;

// *********************************************************************//
// DispIntf:  IOAuthResponseParserDisp
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {2B8C75E2-9631-4834-9D3B-32C51C7FB962}
// *********************************************************************//
  IOAuthResponseParserDisp = dispinterface
    ['{2B8C75E2-9631-4834-9D3B-32C51C7FB962}']
    procedure Load(const Input: WideString); dispid 1;
    property AccessToken: WideString dispid 2;
    property RefreshToken: WideString dispid 3;
    property IdToken: WideString readonly dispid 4;
    property TokenExpiresInSeconds: Integer dispid 5;
    property EmailInIdToken: WideString dispid 6;
    property AccessTokenTimestamp: TDateTime readonly dispid 7;
    function SaveToFile(const tokenFile: WideString): WordBool; dispid 9;
    function LoadFromFile(const tokenFile: WideString): WordBool; dispid 10;
  end;

// *********************************************************************//
// DispIntf:  _IHttpListenerEvents
// Flags:     (4096) Dispatchable
// GUID:      {A386C7CB-8547-451E-A7DC-CD74BA675247}
// *********************************************************************//
  _IHttpListenerEvents = dispinterface
    ['{A386C7CB-8547-451E-A7DC-CD74BA675247}']
    procedure OnRequest(const oSender: IDispatch; const URL: WideString); dispid 1;
    procedure OnError(const oSender: IDispatch; const ErrorDescription: WideString); dispid 2;
  end;
...
// *********************************************************************//
  ...
  TMailOnSendCommand = procedure(ASender: TObject; const Command: WideString) of object;
  TMailOnServerRespond = procedure(ASender: TObject; const Response: WideString) of object;
  TMailOnWriteLog = procedure(ASender: TObject; const LogContent: WideString) of object;
...
{$ENDIF}
  ...
  protected
    ...
    function Get_IsTaskCompleted: WordBool;
    ...
    function Get_AttachmentEncoding: Integer;
    procedure Set_AttachmentEncoding(pVal: Integer);
    function Get_SignatureEncryptionAlgorithm: Integer;
    procedure Set_SignatureEncryptionAlgorithm(pVal: Integer);
    function Get_OaepHashAlgorithm: Integer;
    procedure Set_OaepHashAlgorithm(pVal: Integer);
    procedure Set_ConnectType(pVal: Integer);
    function Get_ConnectType: Integer;
    procedure Set_EWSImpersonatedUser(const pVal: WideString);
    function Get_EWSImpersonatedUser: WideString;
    procedure Set_DkimSignerConfig(const pVal: IDkimConfig);
    function Get_DkimSignerConfig: IDkimConfig;
  public
...
{$ENDIF}
    ...
    property OnWriteLog: TMailOnWriteLog read FOnWriteLog write FOnWriteLog;
  end;
...
{$ENDIF}
  ...
  protected
    ...
    function Get_Base64Thumbprint: WideString;
...
{$ENDIF}
  ...
  public
    ...
    function GetStringValue(const Source: WideString; const Key: WideString): WideString;
    function GetIntValue(const Source: WideString; const Key: WideString): Integer;
    function GetBoolValue(const Source: WideString; const Key: WideString): WordBool;
    function JwtBase64UrlEncode(const Input: WideString): WideString;
    function JwtBase64UrlDecode(const Input: WideString): WideString;
    function SignRs256(const PfxCertificate: ICertificate; const Playload: WideString): WideString;
    function SignRs256WithPrivateKey(const RsaPrivateKey: WideString; const Playload: WideString): WideString;
    function GetCurrentIAT: Integer;
...
// *********************************************************************//
// The Class CoOAuthResponseParser provides a Create and CreateRemote method to          
// create instances of the default interface IOAuthResponseParser exposed by              
// the CoClass OAuthResponseParser. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoOAuthResponseParser = class
    class function Create: IOAuthResponseParser;
    class function CreateRemote(const MachineName: string): IOAuthResponseParser;
  end;


// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TOAuthResponseParser
// Help String      : OAuthResponseParser Class
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TOAuthResponseParserProperties= class;
{$ENDIF}
  TOAuthResponseParser = class(TOleServer)
  private
    FIntf:        IOAuthResponseParser;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       TOAuthResponseParserProperties;
    function      GetServerProperties: TOAuthResponseParserProperties;
{$ENDIF}
    function      GetDefaultInterface: IOAuthResponseParser;
  protected
    procedure InitServerData; override;
    function Get_AccessToken: WideString;
    procedure Set_AccessToken(const pVal: WideString);
    function Get_RefreshToken: WideString;
    procedure Set_RefreshToken(const pVal: WideString);
    function Get_IdToken: WideString;
    function Get_TokenExpiresInSeconds: Integer;
    procedure Set_TokenExpiresInSeconds(pVal: Integer);
    function Get_EmailInIdToken: WideString;
    procedure Set_EmailInIdToken(const pVal: WideString);
    function Get_AccessTokenTimestamp: TDateTime;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: IOAuthResponseParser);
    procedure Disconnect; override;
    procedure Load(const Input: WideString);
    function SaveToFile(const tokenFile: WideString): WordBool;
    function LoadFromFile(const tokenFile: WideString): WordBool;
    property DefaultInterface: IOAuthResponseParser read GetDefaultInterface;
    property IdToken: WideString read Get_IdToken;
    property AccessTokenTimestamp: TDateTime read Get_AccessTokenTimestamp;
    property AccessToken: WideString read Get_AccessToken write Set_AccessToken;
    property RefreshToken: WideString read Get_RefreshToken write Set_RefreshToken;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TOAuthResponseParserProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TOAuthResponseParserProperties = class(TPersistent)
  private
    FServer:    TOAuthResponseParser;
    function    GetDefaultInterface: IOAuthResponseParser;
    constructor Create(AServer: TOAuthResponseParser);
  protected
    function Get_AccessToken: WideString;
    procedure Set_AccessToken(const pVal: WideString);
    function Get_RefreshToken: WideString;
...
// *********************************************************************//
// The Class CoBrowserUi provides a Create and CreateRemote method to          
// create instances of the default interface IBrowserUi exposed by              
// the CoClass BrowserUi. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoBrowserUi = class
    class function Create: IBrowserUi;
    class function CreateRemote(const MachineName: string): IBrowserUi;
  end;


// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TBrowserUi
// Help String      : BrowserUi Class
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TBrowserUiProperties= class;
{$ENDIF}
  TBrowserUi = class(TOleServer)
  private
    FIntf:        IBrowserUi;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       TBrowserUiProperties;
    function      GetServerProperties: TBrowserUiProperties;
{$ENDIF}
    function      GetDefaultInterface: IBrowserUi;
  protected
    procedure InitServerData; override;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: IBrowserUi);
    procedure Disconnect; override;
    function OpenUrl(const URL: WideString): WordBool;
    function OpenIEObject(const URL: WideString; Left: Integer; Top: Integer; Height: Integer; 
                          Width: Integer): WordBool;
    function GetLastError: WideString;
    function OpenIE(const URL: WideString; IsPrivate: WordBool): WordBool;
    function GetIEVersion: WideString;
    procedure ClosePrivateIE;
    function IsPrivateIEClosed: WordBool;
    procedure CloseBrowserByTitle(const Title: WideString);
    property DefaultInterface: IBrowserUi read GetDefaultInterface;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TBrowserUiProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TBrowserUiProperties = class(TPersistent)
  private
    FServer:    TBrowserUi;
    function    GetDefaultInterface: IBrowserUi;
    constructor Create(AServer: TBrowserUi);
  protected
  public
    property DefaultInterface: IBrowserUi read GetDefaultInterface;
  published
...
// *********************************************************************//
// The Class CoHttpListener provides a Create and CreateRemote method to          
// create instances of the default interface IHttpListener exposed by              
// the CoClass HttpListener. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoHttpListener = class
    class function Create: IHttpListener;
    class function CreateRemote(const MachineName: string): IHttpListener;
  end;

  THttpListenerOnRequest = procedure(ASender: TObject; const oSender: IDispatch; 
                                                       const URL: WideString) of object;
  THttpListenerOnError = procedure(ASender: TObject; const oSender: IDispatch; 
                                                     const ErrorDescription: WideString) of object;


// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : THttpListener
// Help String      : HttpListener Class
// Default Interface: IHttpListener
// Def. Intf. DISP? : No
// Event   Interface: _IHttpListenerEvents
// TypeFlags        : (2) CanCreate
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  THttpListenerProperties= class;
{$ENDIF}
  THttpListener = class(TOleServer)
  private
    FOnRequest: THttpListenerOnRequest;
    FOnError: THttpListenerOnError;
    FIntf:        IHttpListener;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       THttpListenerProperties;
    function      GetServerProperties: THttpListenerProperties;
{$ENDIF}
    function      GetDefaultInterface: IHttpListener;
  protected
    procedure InitServerData; override;
    procedure InvokeEvent(DispID: TDispID; var Params: TVariantArray); override;
    function Get_RequestUrl: WideString;
    function Get_ListenPort: Integer;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: IHttpListener);
    procedure Disconnect; override;
    function Create1(const IPv4Address: WideString; Port: Integer): WordBool;
    function GetRequestUrl(Timeout: Integer): WordBool;
    function SendResponse(const ResponseCode: WideString; const ContentType: WideString; 
                          const Content: WideString): WordBool;
    procedure Close;
    function GetLastError: WideString;
    procedure ClearUrl;
    function BeginGetRequestUrl: WordBool;
    property DefaultInterface: IHttpListener read GetDefaultInterface;
    property RequestUrl: WideString read Get_RequestUrl;
    property ListenPort: Integer read Get_ListenPort;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: THttpListenerProperties read GetServerProperties;
{$ENDIF}
    property OnRequest: THttpListenerOnRequest read FOnRequest write FOnRequest;
    property OnError: THttpListenerOnError read FOnError write FOnError;
  end;
...
//  of the properties of this server)
// *********************************************************************//
 THttpListenerProperties = class(TPersistent)
  private
    FServer:    THttpListener;
    function    GetDefaultInterface: IHttpListener;
    constructor Create(AServer: THttpListener);
  protected
    function Get_RequestUrl: WideString;
    function Get_ListenPort: Integer;
  public
...
// *********************************************************************//
// The Class CoDkimConfig provides a Create and CreateRemote method to          
// create instances of the default interface IDkimConfig exposed by              
// the CoClass DkimConfig. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoDkimConfig = class
    class function Create: IDkimConfig;
    class function CreateRemote(const MachineName: string): IDkimConfig;
  end;


// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TDkimConfig
// Help String      : DkimConfig Class
// Default Interface: IDkimConfig
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (2) CanCreate
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TDkimConfigProperties= class;
{$ENDIF}
  TDkimConfig = class(TOleServer)
  private
    FIntf:        IDkimConfig;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       TDkimConfigProperties;
    function      GetServerProperties: TDkimConfigProperties;
{$ENDIF}
    function      GetDefaultInterface: IDkimConfig;
  protected
    procedure InitServerData; override;
    function Get_Domain: WideString;
    procedure Set_Domain(const pVal: WideString);
    function Get_Selector: WideString;
    procedure Set_Selector(const pVal: WideString);
    function Get_PrivateKey: WideString;
    procedure Set_PrivateKey(const pVal: WideString);
    function Get_HeadersToSign: WideString;
    procedure Set_HeadersToSign(const pVal: WideString);
    function Get_IsSignHeaderOnly: WordBool;
    procedure Set_IsSignHeaderOnly(pVal: WordBool);
    function Get_RsaHashAlgorithm: Integer;
    procedure Set_RsaHashAlgorithm(pVal: Integer);
    function Get_CanonAlgorithm: Integer;
    procedure Set_CanonAlgorithm(pVal: Integer);
    function Get_PublicKey: WideString;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: IDkimConfig);
    procedure Disconnect; override;
    function LoadFromJson(const json: WideString): WordBool;
    function LoadFromFile(const jsonFile: WideString): WordBool;
    function ToJson: WideString;
    function SaveToFile(const jsonFile: WideString; overwrite: WordBool): WordBool;
    property DefaultInterface: IDkimConfig read GetDefaultInterface;
    property PublicKey: WideString read Get_PublicKey;
    property Domain: WideString read Get_Domain write Set_Domain;
    property Selector: WideString read Get_Selector write Set_Selector;
    property PrivateKey: WideString read Get_PrivateKey write Set_PrivateKey;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TDkimConfigProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TDkimConfigProperties = class(TPersistent)
  private
    FServer:    TDkimConfig;
    function    GetDefaultInterface: IDkimConfig;
    constructor Create(AServer: TDkimConfig);
  protected
    function Get_Domain: WideString;
    procedure Set_Domain(const pVal: WideString);
    function Get_Selector: WideString;
...
begin
  case DispID of
    ...
    6: if Assigned(FOnSendCommand) then
         FOnSendCommand(Self, Params[0] {const WideString});
    7: if Assigned(FOnServerRespond) then
         FOnServerRespond(Self, Params[0] {const WideString});
    8: if Assigned(FOnWriteLog) then
         FOnWriteLog(Self, Params[0] {const WideString});
  end; {case DispID}
end;
...
function TMail.Get_IsTaskCompleted: WordBool;
begin
    Result := DefaultInterface.IsTaskCompleted;
end;
...
function TMail.Get_AttachmentEncoding: Integer;
begin
    Result := DefaultInterface.AttachmentEncoding;
end;

procedure TMail.Set_AttachmentEncoding(pVal: Integer);
begin
  DefaultInterface.Set_AttachmentEncoding(pVal);
end;

function TMail.Get_SignatureEncryptionAlgorithm: Integer;
begin
    Result := DefaultInterface.SignatureEncryptionAlgorithm;
end;

procedure TMail.Set_SignatureEncryptionAlgorithm(pVal: Integer);
begin
  DefaultInterface.Set_SignatureEncryptionAlgorithm(pVal);
end;

function TMail.Get_OaepHashAlgorithm: Integer;
begin
    Result := DefaultInterface.OaepHashAlgorithm;
end;

procedure TMail.Set_OaepHashAlgorithm(pVal: Integer);
begin
  DefaultInterface.Set_OaepHashAlgorithm(pVal);
end;

procedure TMail.Set_ConnectType(pVal: Integer);
begin
  DefaultInterface.Set_ConnectType(pVal);
end;

function TMail.Get_ConnectType: Integer;
begin
    Result := DefaultInterface.ConnectType;
end;

procedure TMail.Set_EWSImpersonatedUser(const pVal: WideString);
  { Warning: The property EWSImpersonatedUser has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.EWSImpersonatedUser := pVal;
end;

function TMail.Get_EWSImpersonatedUser: WideString;
begin
    Result := DefaultInterface.EWSImpersonatedUser;
end;

procedure TMail.Set_DkimSignerConfig(const pVal: IDkimConfig);
begin
  DefaultInterface.Set_DkimSignerConfig(pVal);
end;

function TMail.Get_DkimSignerConfig: IDkimConfig;
begin
    Result := DefaultInterface.DkimSignerConfig;
end;
...
function TMail.SaveAsDraft: Integer;
begin
  Result := DefaultInterface.SaveAsDraft;
end;
...
function TMailProperties.Get_IsTaskCompleted: WordBool;
begin
    Result := DefaultInterface.IsTaskCompleted;
end;
...
function TMailProperties.Get_AttachmentEncoding: Integer;
begin
    Result := DefaultInterface.AttachmentEncoding;
end;

procedure TMailProperties.Set_AttachmentEncoding(pVal: Integer);
begin
  DefaultInterface.Set_AttachmentEncoding(pVal);
end;

function TMailProperties.Get_SignatureEncryptionAlgorithm: Integer;
begin
    Result := DefaultInterface.SignatureEncryptionAlgorithm;
end;

procedure TMailProperties.Set_SignatureEncryptionAlgorithm(pVal: Integer);
begin
  DefaultInterface.Set_SignatureEncryptionAlgorithm(pVal);
end;

function TMailProperties.Get_OaepHashAlgorithm: Integer;
begin
    Result := DefaultInterface.OaepHashAlgorithm;
end;

procedure TMailProperties.Set_OaepHashAlgorithm(pVal: Integer);
begin
  DefaultInterface.Set_OaepHashAlgorithm(pVal);
end;

procedure TMailProperties.Set_ConnectType(pVal: Integer);
begin
  DefaultInterface.Set_ConnectType(pVal);
end;

function TMailProperties.Get_ConnectType: Integer;
begin
    Result := DefaultInterface.ConnectType;
end;

procedure TMailProperties.Set_EWSImpersonatedUser(const pVal: WideString);
  { Warning: The property EWSImpersonatedUser has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TMailProperties.Get_EWSImpersonatedUser: WideString;
begin
    Result := DefaultInterface.EWSImpersonatedUser;
end;

procedure TMailProperties.Set_DkimSignerConfig(const pVal: IDkimConfig);
begin
  DefaultInterface.Set_DkimSignerConfig(pVal);
end;

function TMailProperties.Get_DkimSignerConfig: IDkimConfig;
begin
    Result := DefaultInterface.DkimSignerConfig;
end;
...
function TCertificate.Get_Base64Thumbprint: WideString;
begin
    Result := DefaultInterface.Base64Thumbprint;
end;
...
function TCertificateProperties.Get_Base64Thumbprint: WideString;
begin
    Result := DefaultInterface.Base64Thumbprint;
end;
...
function TSimpleJsonParser.GetStringValue(const Source: WideString; const Key: WideString): WideString;
begin
  Result := DefaultInterface.GetStringValue(Source, Key);
end;

function TSimpleJsonParser.GetIntValue(const Source: WideString; const Key: WideString): Integer;
begin
  Result := DefaultInterface.GetIntValue(Source, Key);
end;

function TSimpleJsonParser.GetBoolValue(const Source: WideString; const Key: WideString): WordBool;
begin
  Result := DefaultInterface.GetBoolValue(Source, Key);
end;

function TSimpleJsonParser.JwtBase64UrlEncode(const Input: WideString): WideString;
begin
  Result := DefaultInterface.JwtBase64UrlEncode(Input);
end;

function TSimpleJsonParser.JwtBase64UrlDecode(const Input: WideString): WideString;
begin
  Result := DefaultInterface.JwtBase64UrlDecode(Input);
end;

function TSimpleJsonParser.SignRs256(const PfxCertificate: ICertificate; const Playload: WideString): WideString;
begin
  Result := DefaultInterface.SignRs256(PfxCertificate, Playload);
end;

function TSimpleJsonParser.SignRs256WithPrivateKey(const RsaPrivateKey: WideString; 
                                                   const Playload: WideString): WideString;
begin
  Result := DefaultInterface.SignRs256WithPrivateKey(RsaPrivateKey, Playload);
end;

function TSimpleJsonParser.GetCurrentIAT: Integer;
begin
  Result := DefaultInterface.GetCurrentIAT;
end;
...
class function CoOAuthResponseParser.Create: IOAuthResponseParser;
begin
  Result := CreateComObject(CLASS_OAuthResponseParser) as IOAuthResponseParser;
end;

class function CoOAuthResponseParser.CreateRemote(const MachineName: string): IOAuthResponseParser;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_OAuthResponseParser) as IOAuthResponseParser;
end;

procedure TOAuthResponseParser.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{60534020-0887-486D-B6B7-0F177D43C00C}';
    IntfIID:   '{2B8C75E2-9631-4834-9D3B-32C51C7FB962}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TOAuthResponseParser.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as IOAuthResponseParser;
  end;
end;

procedure TOAuthResponseParser.ConnectTo(svrIntf: IOAuthResponseParser);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TOAuthResponseParser.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TOAuthResponseParser.GetDefaultInterface: IOAuthResponseParser;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call ''Connect'' or ''ConnectTo'' before this operation');
...
constructor TOAuthResponseParser.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TOAuthResponseParserProperties.Create(Self);
{$ENDIF}
end;

destructor TOAuthResponseParser.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TOAuthResponseParser.GetServerProperties: TOAuthResponseParserProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TOAuthResponseParser.Get_AccessToken: WideString;
begin
    Result := DefaultInterface.AccessToken;
end;

procedure TOAuthResponseParser.Set_AccessToken(const pVal: WideString);
  { Warning: The property AccessToken has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.AccessToken := pVal;
end;

function TOAuthResponseParser.Get_RefreshToken: WideString;
begin
    Result := DefaultInterface.RefreshToken;
end;

procedure TOAuthResponseParser.Set_RefreshToken(const pVal: WideString);
  { Warning: The property RefreshToken has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.RefreshToken := pVal;
end;

function TOAuthResponseParser.Get_IdToken: WideString;
begin
    Result := DefaultInterface.IdToken;
end;

function TOAuthResponseParser.Get_TokenExpiresInSeconds: Integer;
begin
    Result := DefaultInterface.TokenExpiresInSeconds;
end;

procedure TOAuthResponseParser.Set_TokenExpiresInSeconds(pVal: Integer);
begin
  DefaultInterface.Set_TokenExpiresInSeconds(pVal);
end;

function TOAuthResponseParser.Get_EmailInIdToken: WideString;
begin
    Result := DefaultInterface.EmailInIdToken;
end;

procedure TOAuthResponseParser.Set_EmailInIdToken(const pVal: WideString);
  { Warning: The property EmailInIdToken has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.EmailInIdToken := pVal;
end;

function TOAuthResponseParser.Get_AccessTokenTimestamp: TDateTime;
begin
    Result := DefaultInterface.AccessTokenTimestamp;
end;

procedure TOAuthResponseParser.Load(const Input: WideString);
begin
  DefaultInterface.Load(Input);
end;

function TOAuthResponseParser.SaveToFile(const tokenFile: WideString): WordBool;
begin
  Result := DefaultInterface.SaveToFile(tokenFile);
end;

function TOAuthResponseParser.LoadFromFile(const tokenFile: WideString): WordBool;
begin
  Result := DefaultInterface.LoadFromFile(tokenFile);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TOAuthResponseParserProperties.Create(AServer: TOAuthResponseParser);
begin
  inherited Create;
  FServer := AServer;
end;

function TOAuthResponseParserProperties.GetDefaultInterface: IOAuthResponseParser;
begin
  Result := FServer.DefaultInterface;
end;

function TOAuthResponseParserProperties.Get_AccessToken: WideString;
begin
    Result := DefaultInterface.AccessToken;
end;

procedure TOAuthResponseParserProperties.Set_AccessToken(const pVal: WideString);
  { Warning: The property AccessToken has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TOAuthResponseParserProperties.Get_RefreshToken: WideString;
begin
    Result := DefaultInterface.RefreshToken;
end;

procedure TOAuthResponseParserProperties.Set_RefreshToken(const pVal: WideString);
  { Warning: The property RefreshToken has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TOAuthResponseParserProperties.Get_IdToken: WideString;
begin
    Result := DefaultInterface.IdToken;
end;

function TOAuthResponseParserProperties.Get_TokenExpiresInSeconds: Integer;
begin
    Result := DefaultInterface.TokenExpiresInSeconds;
end;

procedure TOAuthResponseParserProperties.Set_TokenExpiresInSeconds(pVal: Integer);
begin
  DefaultInterface.Set_TokenExpiresInSeconds(pVal);
end;

function TOAuthResponseParserProperties.Get_EmailInIdToken: WideString;
begin
    Result := DefaultInterface.EmailInIdToken;
end;

procedure TOAuthResponseParserProperties.Set_EmailInIdToken(const pVal: WideString);
  { Warning: The property EmailInIdToken has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TOAuthResponseParserProperties.Get_AccessTokenTimestamp: TDateTime;
begin
    Result := DefaultInterface.AccessTokenTimestamp;
end;
...
class function CoBrowserUi.Create: IBrowserUi;
begin
  Result := CreateComObject(CLASS_BrowserUi) as IBrowserUi;
end;

class function CoBrowserUi.CreateRemote(const MachineName: string): IBrowserUi;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_BrowserUi) as IBrowserUi;
end;

procedure TBrowserUi.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{539C9DBC-57D4-4ACB-8A91-329A2CC6270E}';
    IntfIID:   '{217785E8-1188-4FDD-BBB8-1EB104D32151}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
begin
  ...
  begin
    punk := GetServer;
    Fintf:= punk as IBrowserUi;
  end;
end;

procedure TBrowserUi.ConnectTo(svrIntf: IBrowserUi);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TBrowserUi.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TBrowserUi.GetDefaultInterface: IBrowserUi;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call ''Connect'' or ''ConnectTo'' before this operation');
...
constructor TBrowserUi.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TBrowserUiProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TBrowserUi.GetServerProperties: TBrowserUiProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TBrowserUi.OpenUrl(const URL: WideString): WordBool;
begin
  Result := DefaultInterface.OpenUrl(URL);
end;

function TBrowserUi.OpenIEObject(const URL: WideString; Left: Integer; Top: Integer; 
                                 Height: Integer; Width: Integer): WordBool;
begin
  Result := DefaultInterface.OpenIEObject(URL, Left, Top, Height, Width);
end;

function TBrowserUi.GetLastError: WideString;
begin
  Result := DefaultInterface.GetLastError;
end;

function TBrowserUi.OpenIE(const URL: WideString; IsPrivate: WordBool): WordBool;
begin
  Result := DefaultInterface.OpenIE(URL, IsPrivate);
end;

function TBrowserUi.GetIEVersion: WideString;
begin
  Result := DefaultInterface.GetIEVersion;
end;

procedure TBrowserUi.ClosePrivateIE;
begin
  DefaultInterface.ClosePrivateIE;
end;

function TBrowserUi.IsPrivateIEClosed: WordBool;
begin
  Result := DefaultInterface.IsPrivateIEClosed;
end;

procedure TBrowserUi.CloseBrowserByTitle(const Title: WideString);
begin
  DefaultInterface.CloseBrowserByTitle(Title);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TBrowserUiProperties.Create(AServer: TBrowserUi);
begin
  inherited Create;
  FServer := AServer;
end;

function TBrowserUiProperties.GetDefaultInterface: IBrowserUi;
begin
  Result := FServer.DefaultInterface;
end;
...
class function CoHttpListener.Create: IHttpListener;
begin
  Result := CreateComObject(CLASS_HttpListener) as IHttpListener;
end;

class function CoHttpListener.CreateRemote(const MachineName: string): IHttpListener;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_HttpListener) as IHttpListener;
end;

procedure THttpListener.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{7CFF2534-946A-495E-A356-7D01F71F3449}';
    IntfIID:   '{011E1175-8AC1-40D5-BC61-903999FAAC8D}';
    EventIID:  '{A386C7CB-8547-451E-A7DC-CD74BA675247}';
    LicenseKey: nil;
    Version: 500);
begin
  ServerData := @CServerData;
...
procedure THttpListener.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    ConnectEvents(punk);
    Fintf:= punk as IHttpListener;
  end;
end;

procedure THttpListener.ConnectTo(svrIntf: IHttpListener);
begin
  Disconnect;
  FIntf := svrIntf;
  ConnectEvents(FIntf);
...
procedure THttpListener.DisConnect;
begin
  if Fintf <> nil then
  begin
    DisconnectEvents(FIntf);
...
function THttpListener.GetDefaultInterface: IHttpListener;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call ''Connect'' or ''ConnectTo'' before this operation');
...
constructor THttpListener.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := THttpListenerProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function THttpListener.GetServerProperties: THttpListenerProperties;
begin
  Result := FProps;
end;
{$ENDIF}

procedure THttpListener.InvokeEvent(DispID: TDispID; var Params: TVariantArray);
begin
  case DispID of
    -1: Exit;  // DISPID_UNKNOWN
    1: if Assigned(FOnRequest) then
         FOnRequest(Self,
...
function THttpListener.Get_RequestUrl: WideString;
begin
    Result := DefaultInterface.RequestUrl;
end;

function THttpListener.Get_ListenPort: Integer;
begin
    Result := DefaultInterface.ListenPort;
end;

function THttpListener.Create1(const IPv4Address: WideString; Port: Integer): WordBool;
begin
  Result := DefaultInterface.Create(IPv4Address, Port);
end;

function THttpListener.GetRequestUrl(Timeout: Integer): WordBool;
begin
  Result := DefaultInterface.GetRequestUrl(Timeout);
end;

function THttpListener.SendResponse(const ResponseCode: WideString; const ContentType: WideString; 
                                    const Content: WideString): WordBool;
begin
  Result := DefaultInterface.SendResponse(ResponseCode, ContentType, Content);
end;

procedure THttpListener.Close;
begin
  DefaultInterface.Close;
end;

function THttpListener.GetLastError: WideString;
begin
  Result := DefaultInterface.GetLastError;
end;

procedure THttpListener.ClearUrl;
begin
  DefaultInterface.ClearUrl;
end;

function THttpListener.BeginGetRequestUrl: WordBool;
begin
  Result := DefaultInterface.BeginGetRequestUrl;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor THttpListenerProperties.Create(AServer: THttpListener);
begin
  inherited Create;
  FServer := AServer;
end;

function THttpListenerProperties.GetDefaultInterface: IHttpListener;
begin
  Result := FServer.DefaultInterface;
end;

function THttpListenerProperties.Get_RequestUrl: WideString;
begin
    Result := DefaultInterface.RequestUrl;
end;

function THttpListenerProperties.Get_ListenPort: Integer;
begin
    Result := DefaultInterface.ListenPort;
end;
...
class function CoDkimConfig.Create: IDkimConfig;
begin
  Result := CreateComObject(CLASS_DkimConfig) as IDkimConfig;
end;

class function CoDkimConfig.CreateRemote(const MachineName: string): IDkimConfig;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_DkimConfig) as IDkimConfig;
end;

procedure TDkimConfig.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{65653AA2-8E17-4F5C-A8C3-1991E8856359}';
    IntfIID:   '{DA08318D-E853-4E45-AA3F-2B95CC51C16C}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
begin
  ...
  begin
    punk := GetServer;
    Fintf:= punk as IDkimConfig;
  end;
end;

procedure TDkimConfig.ConnectTo(svrIntf: IDkimConfig);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TDkimConfig.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TDkimConfig.GetDefaultInterface: IDkimConfig;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call ''Connect'' or ''ConnectTo'' before this operation');
...
constructor TDkimConfig.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TDkimConfigProperties.Create(Self);
{$ENDIF}
end;

destructor TDkimConfig.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TDkimConfig.GetServerProperties: TDkimConfigProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TDkimConfig.Get_Domain: WideString;
begin
    Result := DefaultInterface.Domain;
end;

procedure TDkimConfig.Set_Domain(const pVal: WideString);
...
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.Domain := pVal;
end;

function TDkimConfig.Get_Selector: WideString;
begin
    Result := DefaultInterface.Selector;
end;

procedure TDkimConfig.Set_Selector(const pVal: WideString);
  { Warning: The property Selector has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.Selector := pVal;
end;

function TDkimConfig.Get_PrivateKey: WideString;
begin
    Result := DefaultInterface.PrivateKey;
end;

procedure TDkimConfig.Set_PrivateKey(const pVal: WideString);
  { Warning: The property PrivateKey has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.PrivateKey := pVal;
end;

function TDkimConfig.Get_HeadersToSign: WideString;
begin
    Result := DefaultInterface.HeadersToSign;
end;

procedure TDkimConfig.Set_HeadersToSign(const pVal: WideString);
  { Warning: The property HeadersToSign has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.HeadersToSign := pVal;
end;

function TDkimConfig.Get_IsSignHeaderOnly: WordBool;
begin
    Result := DefaultInterface.IsSignHeaderOnly;
end;

procedure TDkimConfig.Set_IsSignHeaderOnly(pVal: WordBool);
begin
  DefaultInterface.Set_IsSignHeaderOnly(pVal);
end;

function TDkimConfig.Get_RsaHashAlgorithm: Integer;
begin
    Result := DefaultInterface.RsaHashAlgorithm;
end;

procedure TDkimConfig.Set_RsaHashAlgorithm(pVal: Integer);
begin
  DefaultInterface.Set_RsaHashAlgorithm(pVal);
end;

function TDkimConfig.Get_CanonAlgorithm: Integer;
begin
    Result := DefaultInterface.CanonAlgorithm;
end;

procedure TDkimConfig.Set_CanonAlgorithm(pVal: Integer);
begin
  DefaultInterface.Set_CanonAlgorithm(pVal);
end;

function TDkimConfig.Get_PublicKey: WideString;
begin
    Result := DefaultInterface.PublicKey;
end;

function TDkimConfig.LoadFromJson(const json: WideString): WordBool;
begin
  Result := DefaultInterface.LoadFromJson(json);
end;

function TDkimConfig.LoadFromFile(const jsonFile: WideString): WordBool;
begin
  Result := DefaultInterface.LoadFromFile(jsonFile);
end;

function TDkimConfig.ToJson: WideString;
begin
  Result := DefaultInterface.ToJson;
end;

function TDkimConfig.SaveToFile(const jsonFile: WideString; overwrite: WordBool): WordBool;
begin
  Result := DefaultInterface.SaveToFile(jsonFile, overwrite);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TDkimConfigProperties.Create(AServer: TDkimConfig);
begin
  inherited Create;
  FServer := AServer;
end;

function TDkimConfigProperties.GetDefaultInterface: IDkimConfig;
begin
  Result := FServer.DefaultInterface;
end;

function TDkimConfigProperties.Get_Domain: WideString;
begin
    Result := DefaultInterface.Domain;
end;

procedure TDkimConfigProperties.Set_Domain(const pVal: WideString);
  { Warning: The property Domain has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TDkimConfigProperties.Get_Selector: WideString;
begin
    Result := DefaultInterface.Selector;
end;

procedure TDkimConfigProperties.Set_Selector(const pVal: WideString);
  { Warning: The property Selector has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TDkimConfigProperties.Get_PrivateKey: WideString;
begin
    Result := DefaultInterface.PrivateKey;
end;

procedure TDkimConfigProperties.Set_PrivateKey(const pVal: WideString);
  { Warning: The property PrivateKey has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TDkimConfigProperties.Get_HeadersToSign: WideString;
begin
    Result := DefaultInterface.HeadersToSign;
end;

procedure TDkimConfigProperties.Set_HeadersToSign(const pVal: WideString);
  { Warning: The property HeadersToSign has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TDkimConfigProperties.Get_IsSignHeaderOnly: WordBool;
begin
    Result := DefaultInterface.IsSignHeaderOnly;
end;

procedure TDkimConfigProperties.Set_IsSignHeaderOnly(pVal: WordBool);
begin
  DefaultInterface.Set_IsSignHeaderOnly(pVal);
end;

function TDkimConfigProperties.Get_RsaHashAlgorithm: Integer;
begin
    Result := DefaultInterface.RsaHashAlgorithm;
end;

procedure TDkimConfigProperties.Set_RsaHashAlgorithm(pVal: Integer);
begin
  DefaultInterface.Set_RsaHashAlgorithm(pVal);
end;

function TDkimConfigProperties.Get_CanonAlgorithm: Integer;
begin
    Result := DefaultInterface.CanonAlgorithm;
end;

procedure TDkimConfigProperties.Set_CanonAlgorithm(pVal: Integer);
begin
  DefaultInterface.Set_CanonAlgorithm(pVal);
end;

function TDkimConfigProperties.Get_PublicKey: WideString;
begin
    Result := DefaultInterface.PublicKey;
end;
...
begin
  RegisterComponents(dtlServerPage, [TMail, TFastSender, TCertificate, TCertificateCollection, 
    TSimpleJsonParser, TSimpleJsonArray, TOAuthResponseParser, TBrowserUi, THttpListener, 
    TDkimConfig]);
end;
